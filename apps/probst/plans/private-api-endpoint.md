...
- Before deployment, the full generated Caddyfile matched the then-live file byte-for-byte except for the new Castaway site. The active Caddyfile reached the expected candidate hash after apply.
