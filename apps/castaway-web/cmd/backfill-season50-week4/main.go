...
func run() error {
	...
	groups := []groupSpec{
		{Name: "Tangerine", Members: []string{"Adam", "Mooney", "Grant", "Kyle", "Keith"}},
		{Name: "Leaf", Members: []string{"Keeling", "Kate", "Kenny", "Sarah", "Marv", "Riley"}},
		{Name: "Lotus", Members: []string{"Amanda", "Katie", "Yacob", "Lauren", "Bryan"}},
	}
	...
	tangerineOccurrence, err := ensureManualAdjustmentOccurrence(ctx, svc, q, montyHallActivity.ID, "Monty Hall — Tangerine Door 2 (+2 bonus)", mustTime("2026-03-19T01:00:00Z"), []adjustmentParticipant{
		{Name: "Adam", Points: 2}, {Name: "Mooney", Points: 2}, {Name: "Grant", Points: 2}, {Name: "Kyle", Points: 2}, {Name: "Keith", Points: 2},
	...
	lotusOccurrence, err := ensureManualAdjustmentOccurrence(ctx, svc, q, montyHallActivity.ID, "Monty Hall — Lotus Door 3 (+1 bonus)", mustTime("2026-03-19T01:01:00Z"), []adjustmentParticipant{
		{Name: "Amanda", Points: 1}, {Name: "Katie", Points: 1}, {Name: "Yacob", Points: 1}, {Name: "Lauren", Points: 1}, {Name: "Bryan", Points: 1},
	...
	leafScrollOccurrence, err := ensureManualAdjustmentOccurrence(ctx, svc, q, montyHallActivity.ID, "Monty Hall — Leaf Loan Shark Advantage Scroll (+1 secret bonus)", mustTime("2026-03-19T01:02:00Z"), []adjustmentParticipant{
		{Name: "Keeling", Points: 1}, {Name: "Kate", Points: 1}, {Name: "Kenny", Points: 1}, {Name: "Sarah", Points: 1}, {Name: "Marv", Points: 1}, {Name: "Riley", Points: 1},
	...
	for _, name := range []string{"Keeling", "Kate", "Kenny", "Sarah", "Marv", "Riley"} {
